...
abstract class Payment extends DataContainer {

    /**
     * @var int $id Uniq identifier of payment in Paybox database
     */

    public $id;

    /**
     * @var int $refundAmount Using for Pay\Facade::refund and Pay\Facade::revert
     */
